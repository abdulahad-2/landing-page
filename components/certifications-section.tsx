...
const CertificationIcon = ({
  ...
  return (
    <Award className={className || "h-6 w-6 sm:h-8 sm:w-8 text-cyan-500"} />
  );
};
...
const certifications = [
  {
    ...
    description:
      "Mastery in integrating Lottie animations into Figma designs, enhancing UI/UX with dynamic animations.",
  },
  {
    id: 2,
    ...
    description:
      "A proof of my commitment to continuous learning in data science and analytics through DataCamp's scholarship program.",
  },
  {
    id: 3,
    ...
    description:
      "3rd place in the FlutterFlow Hackfest: Impact Challenge, showcasing my skills in building impactful applications using FlutterFlow.",
  },
];
                  ...
                  <div className="md:col-span-3 p-4 sm:p-6 flex flex-col justify-center">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      <div className="flex-1">
                        <h3
                          className={`text-lg sm:text-xl font-playfair font-semibold mb-2 transition-colors duration-300 ${
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-3">
                          ...
                          <Badge
                            variant="outline"
                            className="text-xs font-inconsolata w-fit"
                          >
                            {cert.date}
                          </Badge>
                        </div>
                      ...
                      <div className="flex-shrink-0">
                        <div
                          className={`flex items-center gap-2 text-cyan-600 text-sm font-inconsolata font-medium transition-all duration-300 ${
            ...
            {selectedCert && (
              <div className="space-y-4">
                <Image
                  ...
                  width={800} // or a width that fits your design
                  height={500} // approximate height to maintain aspect ratio
