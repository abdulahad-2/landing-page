...
const contactMethods = [
  {
    ...
    handle: "Abdul Ahad",
    url: "mailto:abdul.ahadt732@gmail.com",
  ...
  },
  {
    ...
    handle: "@Abdul Ahad",
    url: "https://www.linkedin.com/in/abdul-ahad-7908a82b4/",
  ...
  },
  {
    ...
    handle: "@Abdul Ahad",
    url: "https://github.com/abdulahad-2",
        ...
        <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                >
                  <CardContent className="p-6 sm:p-8 text-center min-h-[140px] flex flex-col justify-center">
                    ...
                    <h3 className="font-playfair font-semibold mb-2 text-base sm:text-lg">
                      {method.name}
                    </h3>
          ...
          <div className="scroll-animate">
            ...
            <Button
              ...
              className="text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-4 transition-all duration-300 hover:scale-105 interactive-element font-inconsolata ml-4"
            >
              View My Work
            </Button>
          </div>
