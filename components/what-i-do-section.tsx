...
const developSkills = [
  ...
  'Firebase', 'Supabase', 'MySQL','WordPress','PHP','HTML','JavaScript','Shopify'
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6 leading-relaxed font-inconsolata">
              I specialize in crafting high-performance, responsive web applications and mobile apps, leveraging modern frameworks to deliver seamless digital experiences.
            </p>
            
            <div className="mb-4">
              <h4 className={`font-playfair font-semibold mb-2 sm:mb-3 transition-all duration-300 text-sm sm:text-base ${
                hoveredSection === 'develop' ? 'text-cyan-500' : 'text-foreground'
              }`}>
                Skillset & tools
              </h4>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6 leading-relaxed font-inconsolata">
              I craft compelling visual content and engaging narratives that resonate with audiences, driving impactful communication and brand growth across digital platforms.
            </p>
            
            <div className="mb-4">
              <h4 className={`font-playfair font-semibold mb-2 sm:mb-3 transition-all duration-300 text-sm sm:text-base ${
                hoveredSection === 'create' ? 'text-emerald-500' : 'text-foreground'
              }`}>
                Skillset & Tools
              </h4>
              <div className="flex flex-wrap gap-1 sm:gap-2">
