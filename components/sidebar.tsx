        ...
        <div className="flex flex-col h-full p-4 sm:p-6">
          ...
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            ...
            <div className="relative group cursor-pointer">
              <div className="w-[100px] h-[100px] rounded-xl bg-background/80 backdrop-blur-sm border border-border/50 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 group-hover:shadow-lg group-hover:shadow-cyan-500/20">
                <Image
                  src="/logo/lauv-logo2.svg"
                  alt="Lauv Logo"
                  width={120}
                  height={120}
                  className="h-24 w-24 filter dark:invert-0 invert transition-all duration-300 group-hover:scale-110"
                />
              </div>
